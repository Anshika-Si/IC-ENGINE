...
q1=0;  fprintf('q1=%.2f \n',q1);
w1=efficiency*(R/(1-gamma))*(t2-t1);   fprintf('Work done with 75 percent efficiency ,w1=%.2f \n',w1);   
...
w2=efficiency*(q2-u2);    fprintf('Work done with 75 percent efficiency , w2=%.2f \n',w2);
...
w3=efficiency*(R*t4*log(p3/p4));    fprintf('Work done with 75 percent efficiency , w3=%.2f \n',w3);
q3=w3;      fprintf('q3=%.2f \n',q3);
